...
static string gen_instruction(idClass ast) {
	...
	with (op) {
		...
		case rShift: result ~= "rs("; break;
		case lShift: result ~= "ls("; break;
		case addEquals: result ~= "add("; break;
		case subEquals: result ~= "sub("; break;
		case mulEquals: result ~= "mul("; break;
		case divEquals: result ~= "div("; break;
		case modEquals: result ~= "mod("; break;
		case rShiftEquals: result ~= "rs("; break;
		case lShiftEquals: result ~= "ls("; break;
		default: break;
		}
	}
